    ...
    <xsl:template match="book|article">
        <html>
            <head>
                ...
                <script language="Javascript" type="text/javascript" src="libs/styles/curvycorners.js"/>
...
<!--<img src="{$pathToWebapp}{graphic/@fileref}" title="Tamboti Metadata Framework" style="border-style: none;text-decoration: none"/>-->
                ...
                <xsl:otherwise>
                    <div id="page-head-left">
                        <a href="../search/index.xml" style="text-decoration: none">
                            <img src="{$pathToWebapp}logo.jpg" title="Tamboti Metadata Framework" style="border-style: none;text-decoration: none"/>
                        </a>
                    </div>
                    <div id="page-head-right">
                        <a href="http://www.asia-europe.uni-heidelberg.de/en/home.html" target="_blank">
            ...
            <!--
            <div class="app-name">
                <a href="/exist/library/" style="text-decoration: none">
    ...
    <xsl:template name="analytics">
        <xsl:if test="$include.analytics">
            ...
            <object>
                <noscript>
                    <p>
                        <img src="http://apps.sourceforge.net/piwik/exist/piwik.php?idsite=1" alt="piwik"/>
                    </p>
                </noscript>
            </object>
            <!-- End Piwik Tag -->
