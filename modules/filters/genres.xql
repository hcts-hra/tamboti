    ...
    <filters xmlns="">
        {
            for $filter in $distinct-filters
                let $label-1 := doc(concat($config:db-path-to-mods-editor-home, '/code-tables/genre-local.xml'))/mods-editor:code-table/mods-editor:items/mods-editor:item[mods-editor:value eq $filter]/mods-editor:label
                let $label-2 := doc(concat($config:db-path-to-mods-editor-home, '/code-tables/genre-marcgt.xml'))/mods-editor:code-table/mods-editor:items/mods-editor:item[mods-editor:value eq $filter]/mods-editor:label
                let $label :=
                    if ($label-1)
                    then $label-1
                    else
