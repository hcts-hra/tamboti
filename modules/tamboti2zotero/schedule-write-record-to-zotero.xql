...
return (
    ...
    ,
    system:as-user('admin', '', scheduler:schedule-xquery-periodic-job("/apps/tamboti/modules/tamboti2zotero/write-record-to-zotero.xql", 60000, "write-record-to-zotero", $job-parameters, 0, $number-of-tamboti-resources - 1))
)
