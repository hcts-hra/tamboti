...
return (
    ...
    ,
    system:as-user('admin', 'Mdft2012', scheduler:schedule-xquery-periodic-job("/apps/tamboti/modules/tamboti2zotero/write-record-to-zotero.xql", 6000, "write-record-to-zotero", $job-parameters, 0, $number-of-tamboti-resources - 1))
)
