                            ...
                            return
                                ...
                                then
                                    ...
                                    then
                                        ...
                                        for $genre in $genres
                                            let $label-1 := doc(concat($config:edit-app-root, '/code-tables/genre-local.xml'))/mods-editor:code-table/mods-editor:items/mods-editor:item[mods-editor:value eq $genre]/mods-editor:label
                                            let $label-2 := doc(concat($config:edit-app-root, '/code-tables/genre-marcgt.xml'))/mods-editor:code-table/mods-editor:items/mods-editor:item[mods-editor:value eq $genre]/mods-editor:label
                                            let $label := 
                                                if ($label-1)
                                                then $label-1
                                                else 
